    ...
    <div style="padding: 0 25px;">
        <table style="margin-bottom:40px; margin-top:50px; font-size:20px;">
            <tr>
                ...
                <td><strong>Hallo.</strong><br/> <br/>
                    Sie haben Ihre E-Mail-Adresse erfolgreich verifiziert und
                    sind ab sofort f&uuml;r die Nutzung von JTL-OneTimeLink freigeschaltet.
                </td>
            </tr>
        </table>
    </div>
