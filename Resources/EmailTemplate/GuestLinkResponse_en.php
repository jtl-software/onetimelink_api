...
<div style="margin: auto; align-content: center; width: 100%; max-width:1024px; padding: 0;">
    ...
    <div style="padding: 0 25px;">
        ...
        <tr>
            <td>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height:28px; fill:#324350"><path d="M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z"/><!--[if gte mso 12]><img src="http://wfarm3.dataknet.com/static/resources/icons/set112/d2a3b53a.png" height="28" style="float:left;"/><![endif]--></svg>
            </td>
            <td></td>
            <td><div style="padding-bottom: 20px; border-left: 1px solid #dcdcdc; padding-left: 20px;margin-left: 20px; height:80px;">&nbsp;<div><div>&nbsp;</div>
            </td>
            <td><strong>Hallo <?= ucfirst($data->user) ?>.</strong><br/> <br/>Ihr G&auml;stelink wurde angenommen und ausgef&uuml;llt.
                Besuchen Sie den unten stehenden Link um die Inhalte abzurufen.
            </td>
        </tr>
        </table>
        <div>
            <div style=" padding-top: 20px; padding-bottom: 20px; padding-left: 5px; clear:both;">
                <?php
                $tagsUsed = null;
            ...
            <div style="text-align: center; background-color: #f5f7fa; height: 110px; border-radius: 5px; margin-top: 20px; margin-bottom: 20px; border: 1px solid #dcdcdc">
                <br><br><a style="color: #000000" href="<?= $data->yourLink ?>"><?= $data->yourLink ?></a><p>&nbsp;</p>
            </div>
            <span style="color: #797b80"> <strong>Zur Erinnerung:</strong> Der Inhalt dieses Links steht nur einmalig zur Verf&uuml;gung und und wird nach dem ersten Besuch gel&ouml;scht. </span>
        </div>
    </div>
