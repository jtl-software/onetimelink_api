...
<div style="margin: auto; align-content: center; width: 100%; max-width:1024px; padding: 0;">
    <div style="display: flex; align-items: center; background: #FFFFFF; border-bottom: 1px solid #ddd; padding:20px 0 25px 25px;">
        ...
        <span style="width:50%"><div style="text-align:right; padding-right:25px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height:20px; fill:#324350"><path d="M256 0c88.366 0 160 71.634 160 160s-71.634 160-160 160S96 248.366 96 160 167.634 0 256 0zm183.283 333.821l-71.313-17.828c-74.923 53.89-165.738 41.864-223.94 0l-71.313 17.828C29.981 344.505 0 382.903 0 426.955V464c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48v-37.045c0-44.052-29.981-82.45-72.717-93.134z"/></svg> <?= ucfirst($data->username) ?></div></span>
    </div>
        ...
        <table style="margin-bottom:40px; margin-top:50px; font-size:20px;">
            <tr>
                ...
                <td>
                    ...
                    vielen Dank f&uuml;r Ihre Registrierung bei JTL-OneTimeLink. Bitte verifizieren Sie Ihre E-Mail-Adresse,
                    indem Sie den folgenden Link anklicken oder in Ihren Browser kopieren.
                </td>
            </tr>
        </table>
        <div>
            <div style="clear:both;">
                <div style="text-align: center; background-color: #f5f7fa; height: 110px; border-radius: 5px; margin-top: 20px; margin-bottom: 20px; border: 1px solid #dcdcdc">
                    <br/><br/><a style="color: #000000" href="<?= $data->activationUrl ?>"><?= $data->activationUrl ?></a><p>&nbsp;</p>
                </div>
            </div>
        </div>
    </div>
