...
<div style="margin: auto; align-content: center; width: 100%; padding: 0;">
    <div style="display: flex; align-items: center; background: #FFFFFF; border-bottom: 1px solid #ddd; padding:20px 0 25px 25px;">
        <div style="width:50%">
            <img src="https://otl.jtl-software.de/pics/JTL-logo.png" alt="JTL-OneTimeLink" height="44"/>
        </div>
        <div style="width: 50%; text-align:right; padding-right:25px;">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height:20px; fill:#324350">
    ...
    <div style="padding: 0 25px;">
        <table style="margin-bottom:40px; margin-top:50px; font-size:20px;">
            <tr>
                ...
                <td></td>
                <td>
                    <div style="padding-bottom: 20px; border-left: 1px solid #dcdcdc; padding-left: 20px;margin-left: 20px; height:80px;">&nbsp;</div>
                </td>
                <td>
                    <div style="width: 85vw;word-wrap: break-word;">
                        <strong>Hallo.</strong><br/> <br/>
                        Sie haben ein neus Passwort angefordert. Klicken Sie auf den folgenden Link, um Ihr Passwort zu ändern:<br/>
