    ...
    <div style="padding: 0 25px;">
        <table style="margin-bottom:40px; margin-top:50px; font-size:20px;">
            <tr>
                ...
                <td>
                    ...
                    Thank you for registering with JTL OneTimeLink. Please verify your email address
        ...
        <div>
            <div style="clear:both;">
                <div style=" text-align: center; background: #f5f7fa; padding: 30px; border-radius: 5px; margin-top: 20px; margin-bottom: 20px; border: 1px solid #dcdcdc">
