    ...
    <div style="padding: 0 25px;">
        <table style="margin-bottom:40px; margin-top:50px; font-size:20px;">
            <tr>
                ...
                <td>
                    <strong>Hallo <?= ucfirst($data->user) ?>.</strong><br/>
                    <br/>
        ...
        <div>
            <div style="clear:both">
                ...
                ">
                    ...
                    echo "<strong style='color: #797b80;'>Tags User:</strong>\n" . ($tagsUsed ?? "none");
                    ?>
                </div>

                <span style="color: #797b80">
                    <strong>Time: </strong>&nbsp;<?= date('c') ?><br/>
                    <strong>Client IP (blurred):</strong>&nbsp;<?= $data->ip ?><br/>
